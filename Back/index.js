...
App.post('/displayTodos', (req, res) => {
    ...
    if(resultdisplayTodos.length > 12){
        res.status(200).json({
            string : "Todo list limit is over!",
            idOne : resultdisplayTodos[0].id, titleOne : resultdisplayTodos[0].title, element1One : resultdisplayTodos[0].element1, element2One : resultdisplayTodos[0].element2,
            element3One : resultdisplayTodos[0].element3, element4One : resultdisplayTodos[0].element4, element5One : resultdisplayTodos[0].element5, element6One : resultdisplayTodos[0].element6,
            element7One : resultdisplayTodos[0].element7, element8One : resultdisplayTodos[0].element8, element9One : resultdisplayTodos[0].element9, element10One : resultdisplayTodos[0].element10,
            idTwo : resultdisplayTodos[1].id, titleTwo : resultdisplayTodos[1].title, element1Two : resultdisplayTodos[1].element1, element2Two : resultdisplayTodos[1].element2,
...
App.post('/displayTodo1', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo1.idTodo1)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");      
        }
        if(resultdisplayTodo1.length < 1){

            res.status(200).json({string :"no Todo"});
        }
        else
        {
        res.status(200).json({
...
App.post('/displayTodo2', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo2.idTodo2)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");      
        }
...
App.post('/displayTodo3', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo3.idTodo3)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");      
        }
...
App.post('/displayTodo4', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo4.idTodo4)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");      
        }
...
App.post('/displayTodo5', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo5.idTodo5)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");
        }
...
App.post('/displayTodo6', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo6.idTodo6)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");
        }
...
App.post('/displayTodo7', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo7.idTodo7)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");
        }  
...
App.post('/displayTodo8', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo8.idTodo8)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");
        }    
...
App.post('/displayTodo9', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo9.idTodo9)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");
        }
...
App.post('/displayTodo10', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo10.idTodo10)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");
        }
...
App.post('/displayTodo11', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo11.idTodo11)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");
        }    
...
App.post('/displayTodo12', (req, res) => {
    const addTodo1 = `SELECT * FROM todolist1 WHERE id =${mySql.escape(req.body.idTodo12.idTodo12)}`
    config.query(addTodo1, (err, resultdisplayTodo1) => {
        if(err){
            res.status(200).json("error");
        }
...
App.post('/updateTodo', (req ,res) => {
    ...
    if(req.body.todolist[0].string === 'no Todo'){
        res.status(200).json({string :'noUpdate'})
    }
    else{
